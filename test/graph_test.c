#include "../src/graphs/undirected/graph.h"
...
void test_empty_graph_fails() { TEST_ASSERT_NULL(graph_init(0)); }

// Tests number of vertices is correct.
void test_vertex_count() { TEST_ASSERT_EQUAL(num_v, graph_V(g)); }
