...
// Tests that a queue of ints can be iterated over and that its contents match
...
// Tests that a queue of strings can be iterated over and that its contents
// match the order of insertion
