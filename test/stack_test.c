...
// Tests that a stack of ints can be iterated over and that its contents match
...
// Tests that a stack of strings can be iterated over and that its contents
// match the reverse order of insertion
